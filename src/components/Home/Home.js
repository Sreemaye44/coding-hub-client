    ...
    return (
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption className='text-dark w-50 mx-auto' style={{top:200}}>
           ...
           <Button className='me-3 mb-2' variant="outline-dark">Get Started</Button>
           <Link to='/register' ><Button variant="outline-dark" className='me-3 mb-2'>SignUp Now!</Button></Link>
